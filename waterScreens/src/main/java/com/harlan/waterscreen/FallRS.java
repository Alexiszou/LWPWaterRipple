...
//        mScript.set_g_TRiverbed(loadTexture(R.drawable.pond));
       // mScript.set_g_TRiverbed(loadWallpaperTexture());
        mScript.set_g_TRiverbed(loadTextureARGB(R.drawable.wallpaper1));
    }
    private  Bitmap drawable2Bitmap(Drawable drawable){
        Bitmap bitmap = null;
        bitmap = ((BitmapDrawable)drawable).getBitmap();
        Log.e("zhz","wallpaper width:"+bitmap.getWidth()+",height:"+bitmap.getHeight());
        bitmap = Bitmap.createBitmap(bitmap,0,0,1080,1920);
        savePicture(bitmap,"wallpaper.jpg");
        Log.e("zhz","wallpaper width:"+bitmap.getWidth()+",height:"+bitmap.getHeight());
    ...
    private Allocation loadWallpaperTexture(){


        Bitmap b = drawable2Bitmap(mResources.getDrawable(R.drawable.wallpaper));
    ...
    private Allocation loadTextureARGB(int id) {
       ...
       // mOptionsARGB.inDensity = 3;
        //Bitmap b = BitmapFactory.decodeResource(mResources, id, mOptionsARGB);
        Bitmap b = ((BitmapDrawable)mResources.getDrawable(id)).getBitmap();
        final Allocation allocation = Allocation.createFromBitmap(mRS, b);
        return allocation;
    }
...
//                "    varTex0.xy *= vec2(0.25, 0.33);\n" +
    ...
    public void savePicture(Bitmap bm, String fileName) {
        ...
        Log.i("xing", "savePicture: ------------------path------"+Environment.getExternalStorageDirectory().getAbsolutePath());
        if (!foder.exists()) {
            foder.mkdirs();
        }
        ...
        Log.i("xing", "savePicture: ------------------success------");
    }
}
