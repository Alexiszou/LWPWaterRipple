...
//
    ...
    public Bundle onCommand(String action, int x, int y, int z, Bundle extras,
        ...
        if(action.equals("click")){
            ...
            if(Math.hypot((x-mInitX),(y-mInitY)) > DISTANCE) {
                addDrop(x + (mWorldState.rotate == 0 ? (mWorldState.width * mWorldState.xOffset) : 0), y);
                mInitX = x;
                mInitY = y;
            }
...
//                "    varTex0.xy *= vec2(0.25, 0.33);\n" +
    ...
    /*public void init(Context context, RenderScriptGL rs, Resources res, boolean isPreview) {
        super.init(context,rs,res,isPreview);
    }*/
